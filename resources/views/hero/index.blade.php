                    ...
                    <div
                        ...
                        <div class="relative z-10 p-9">
                            <div class="flex justify-between items-center">
                                <h1 class="text-4xl font-extrabold  text-white">Data Hero</h1>
                                        ...
                                        <div
                                            ...
                                            <div class="p-4">
                                                <div class="flex justify-between gap-2">
                                                    ...
                                                    <form id="deleteForm"
                                                        action="{{ route('hero.destroy', $item->id_hero) }}"
                                                        method="POST">
                                                        @csrf
                                                        @method('DELETE')
                                                        <a href="javascript:;" type="button"
                                                            data-id="{{ $item->id_hero }}"
                                                            data-url="{{ route('hero.destroy', $item->id_hero) }}"
