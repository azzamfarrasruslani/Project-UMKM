                ...
                <div class="w-full">
                    ...
                    <nav id="navbar"
                        ...
                        <div class="flex items-center justify-between w-full p-0 mx-auto flex-wrap-inherit">
                            <img class="inline-flex items-center justify-center text-sm text-white transition-all duration-200 ease-in-out w-14 rounded-xl object-cover"
                            ...
                            <div navbar-menu
                                ...
                                <li class="flex items-center">
                                    <a class="leading-pro bg-red-500 text-white text-sm tracking-tight-rem bg-150 bg-x-25 rounded-3.5xl hover:border-red-500 hover:-translate-y-px hover:text-red-500 active:hover:-translate-y-px active:hover:text-red-500 active:shadow-xs mr-2 mb-0 inline-block cursor-pointer border border-solid py-2 px-8 text-center align-middle font-bold capitalize shadow-none transition-all hover:bg-transparent hover:opacity-75 hover:shadow-none active:scale-100 active:text-white active:hover:bg-transparent active:hover:opacity-75 active:hover:shadow-none"
