<div class="min-h-screen flex flex-col">
    ...
    <!-- Footer -->
    <footer class="bg-customRed-50 py-12">
     ...
     <div class="bg-customRed-100 py-4">
        <div class="container mx-auto px-6 md:px-12 text-white">
            <p class="text-sm">
                <b>&copy; 2024 Ayam Geprek Keysia. All rights reserved.</b>
            </p>
            <p class="text-sm mt-2">
                <a href="https://www.designville.studio/" target="_blank" class="hover:text-red-300 hover:underline">Web design by Tim 1</a>
            </p>
        </div>
    </div>
</div>
