<div id="addPromoModal"
    ...
    <div class="flex items-center justify-center min-h-screen px-4">
        ...
        <div class="bg-white rounded-4 px-16 py-3" id="modalPromo">
            <div class="sm:flex sm:items-start">
                <div class="mt-3 text-center sm:mt-0  sm:text-left">
                        ...
                        <form action="{{ route('promo.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" name="judul" id="judul"
                                    class="mt-1 block w-full border-gray-300 rounded-md" value="{{ old('judul') }}"
                                    required />
                                @error('judul')
                            ...
                            <div class="mb-4">
                                ...
                                <input type="number" name="diskon" id="diskon"
                                    class="mt-1 block w-full border-gray-300 rounded-md" value="{{ old('diskon') }}"
                    ...
                    <div class="flex justify-start mb-4">
                        <button type="submit"
                            class="justify-items-start mb-4 mr-2 rounded-full border border-transparent shadow-sm px-6 py-2 bg-blue-500 text-base font-medium text-white hover:bg-blue-700 focus:outline-none border-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 sm:w-auto sm:text-sm hover:shadow-xs hover:-translate-y-px active:opacity-85">
                            Simpan
                        </button>
                        <button type="button" onclick="closeAddPromo()"
                            class="justify-items-start mb-4 rounded-full border border-transparent shadow-sm px-6 py-2 bg-gradient-to-tl from-red-600 to-orange-600 text-base font-medium text-white hover:bg-blue-700 focus:outline-none border-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 sm:w-auto sm:text-sm hover:shadow-xs hover:-translate-y-px active:opacity-85">
                            Batal
                        </button>
                    </div>
                    </form>
