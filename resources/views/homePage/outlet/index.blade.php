<x-guest-layout>
    ...
    <section class="mx-10 mt-10 mb-10">
        <div class="flex flex-col min-h-[945px]" role="region" aria-label="Store Locations">
            <div class="flex flex-col items-center text-center pt-6 w-full">
                <h1 id="deals-heading" class="pb-2 text-4xl font-extrabold leading-[1.2] text-yellowCustom-50 uppercase tracking-wide">
                ...
                <p class="mt-4 text-lg text-neutral-500 max-w-xl">
                    Jelajahi cabang Ayam Geprek Keysia di berbagai lokasi. Temukan cita rasa terbaik dengan suasana yang nyaman!
                </p>
            </div>


            <div class="mt-6 w-full">
                <div class="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5" role="list">
                    <!-- Outlet Card 1 -->
