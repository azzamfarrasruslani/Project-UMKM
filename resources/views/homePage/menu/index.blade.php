<x-guest-layout>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div class="bg-white shadow-md rounded-lg overflow-hidden">
          <div class="relative">
            <img class="w-full h-48 object-cover" src="https://static.order.kfcku.com/images/items/lg/13655.jpg?v=38B0v4" alt="Nasi Uduk+Telur Dadar">
          </div>
          <div class="p-4">
            <h3 class="text-lg font-semibold">Nasi Uduk+Telur Dadar</h3>
            <p class="text-gray-500 text-sm">1 Nasi Uduk + 1 Telur Dadar</p>
            <div class="mt-2 flex justify-between items-center">
              <span class="text-lg font-bold text-red-600">Rp22.727</span>
