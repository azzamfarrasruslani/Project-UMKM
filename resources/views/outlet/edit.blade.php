                    ...
                    <div class="px-8 mt-6 text-slate-700 lg:mt-0 bg-white">
                        <form action="{{ route('outlet.update', $outlet->id_outlet) }}" method="POST"
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                ...
                                {{-- Jumlah Karyawan --}}
                                <div class="mb-4">
                                    <label for="jumlah_karyawan" class="block text-sm font-medium">Jumlah
                                        Karyawan</label>
                                    <input type="number" name="jumlah_karyawan" id="jumlah_karyawan"
                                        value="{{ $outlet->jumlah_karyawan }}"
                                        class="mt-1 block w-full border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500"
                                ...
                                <div class="mb-4">
                                    ...
                                    <select name="status_outlet" id="status_outlet"
                                        ...
                                        <option value="aktif"
                                            {{ old('status_outlet') === 'aktif' ? 'selected' : '' }}>Aktif
                                        </option>
                                        <option value="non-aktif"
                                            {{ old('status_outlet') === 'non-aktif' ? 'selected' : '' }}>Non-Aktif
                                        </option>
                                    </select>
                                    @error('status_outlet')
                                        <span class="text-red-500 text-sm">{{ $message }}</span>
                                ...
                                <div class="mb-4 sm:col-span-2">
                                    <label for="iframe_map" class="block text-sm font-medium">Embed Map (iframe)
                                        (400x300)</label>
                                ...
                                {{-- Link Layanan Online --}}
                                <div class="mb-4 sm:col-span-2">
                                    <label for="link_pesan_online" class="block text-sm font-medium">Link Layanan
                                        Online</label>
                            ...
                            <div class="mb-4">
                                <label for="gambar_pesan_online" class="block text-sm font-medium">Logo Layanan
                                    online</label>
