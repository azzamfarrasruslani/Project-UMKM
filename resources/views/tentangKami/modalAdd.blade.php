<div id="addTentangKModal"
    ...
    <div class="flex items-center justify-center min-h-screen px-4">
        <div class="bg-white rounded-2xl px-8 py-6 text-slate-700 w-full max-w-4xl max-h-screen overflow-y-auto" id="modalTentangKami">
            <div class="sm:flex sm:items-start">
                <div class="mt-3 text-center sm:mt-0 sm:text-left w-full">
                    ...
                    <div class="mt-2">
                        <form id="tentangKamiForm" action="{{ route('tentangKami.store') }}" method="POST"
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                ...
                                <div class="col-span-2">
                                    ...
                                    <input type="text" name="judul_tK" id="judul_tK"
                                ...
                                <div>
                                    ...
                                    <textarea name="visi" id="visi" rows="2" class="mt-1 block w-full border-gray-300 rounded-md"></textarea>
                                </div>
                                <!-- Misi -->
                                <div>
                                    <label for="misi" class="block text-sm font-medium">Misi</label>
                                    <textarea name="misi" id="misi" rows="2" class="mt-1 block w-full border-gray-300 rounded-md"></textarea>
                                </div>
                                <!-- Gambar Utama -->
                                <div>
                            ...
                            <div class="flex justify-end mt-4 gap-2">
                                <button type="button" onclick="closeAddTentangKami()"
